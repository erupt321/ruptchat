...
--		[12] = '%1 ->\\cs(240,230,140) %2\\cr',
	...
	[148] = { -- instance queue / DI Finish Messages
		...
		[4] = '\\cs(255,215,0)%1\\cr\\cs(240,230,140)%2\\cr[\\cs(218,165,32)%3\\cr]\\cs(240,230,140)%4\\cr[\\cs(218,165,32)%5\\cr]\\cs(240,230,140)%6\\cr',
		[5] = '^([0-9]+:[0-9]+:[0-9]+:)(.-)([0-9]+)(.*)',
		[6] = '\\cs(255,215,0)%1\\cr\\cs(240,230,140)%2\\cr[\\cs(218,165,32)%3\\cr]\\cs(240,230,140)%4\\cr',
		[7] = '^([0-9]+:[0-9]+:[0-9]+:)(.*)',
		[8] = '\\cs(255,215,0)%1\\cr\\cs(240,230,140)%2\\cr',
	},
	[150] = { -- npc chat
		[1] = '^([0-9]+:[0-9]+:[0-9]+:)([^:]+) :(.*)',
		[2] = '\\cs(255,215,0)%1\\cr**[\\cs(218,165,32)%2\\cr]**\\cs(240,230,140)%3\\cr'	
