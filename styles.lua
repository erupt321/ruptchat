return {
	...
	[110] = { --ws mob
		[1] = '^([0-9]+:[0-9]+:[0-9]+.+)('..windower.ffxi.get_player().name..'\'?s?)%]?(.+)',
	...
	[127] = { -- ROE / Obtains
		...
		[3] = '^([0-9]+:[0-9]+:[0-9]+:)([^:]+): (.*)',
		[4] = '\\cs(255,215,0)%1\\cr\\cs(65,105,225)%2\\cr -> %3',
	},
	[131] = { -- XP
		[1] = '^([0-9]+:[0-9]+:[0-9]+:)(.*)',
		[2] = '\\cs(255,215,0)%1\\cr\\cs(240,230,140)%2\\cr',
		[3] = '(.+) ([0-9]+) (.+)',
		[4] = '%1\\cr %2 \\cs(240,230,140)%3\\cr',
		[5] = '(.*)'..string.char(129,170)..'(.*)',
		[6] = '%1 %2',
	},
	[191] = { --buff wear
		[1] = '^([0-9]+:[0-9]+:[0-9]+:)(.*)',
